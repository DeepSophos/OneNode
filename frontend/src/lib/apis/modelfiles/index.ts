...
export const createNewModelfile = async (token: string, modelfile: object) => {
	...
	const res = await fetch(`${ONENODE_API_BASE_URL}/modelfiles/create`, {
		method: 'POST',
		headers: {
...
export const getModelfiles = async (token: string = '') => {
	...
	const res = await fetch(`${ONENODE_API_BASE_URL}/modelfiles/`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateModelfileByTagName = async (
	...
	const res = await fetch(`${ONENODE_API_BASE_URL}/modelfiles/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteModelfileByTagName = async (token: string, tagName: string) => {
	...
	const res = await fetch(`${ONENODE_API_BASE_URL}/modelfiles/delete`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
