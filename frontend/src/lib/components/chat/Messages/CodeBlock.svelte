...
<div>
	<div class="123qwe relative {className} flex flex-col rounded-lg" dir="ltr">
		{#if lang === 'mermaid'}
			{#if mermaidHtml}
				<SvgPanZoom
			...
			{/if}
		{:else}
			<div class="bg-gray-100 text-black dark:text-white dark:bg-gray-850 rounded-t-md absolute z-20 pl-4 py-1.5 text-xs font-medium ">
				{lang}
			</div>

			<div
				class="bg-gray-100 dark:bg-gray-850 rounded-t-md sticky {stickyButtonsClassName} mb-1 py-1 pr-2.5 flex items-center justify-end z-10 text-xs text-black dark:text-white"
			>
