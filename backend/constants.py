...
class ERROR_MESSAGES(str, Enum):
    ...
    UNAVAILABLE = "正在进行知识库导入，当前问答暂不可用，请稍后再试。"
    DELETE_FAILED = lambda item="": f"Oops! Something went wrong. We encountered an issue while trying to delete {item if item else ''}."
    UPDATE_FAILED = lambda item="": f"Oops! Something went wrong. We encountered an issue while trying to update {item if item else ''}."
